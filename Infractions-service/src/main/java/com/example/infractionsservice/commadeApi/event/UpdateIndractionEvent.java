...
public class UpdateIndractionEvent extends BaseInfraction<String> {
    ...
    public UpdateIndractionEvent(String id, Date date, String numeroRadar, String immatriculation, double vitesse, double vitesseMaxAutorise, double montant) {
        super(id);
        this.date = date;
